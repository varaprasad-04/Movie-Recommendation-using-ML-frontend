...
import { fetchPopularMovies, fetchGenres, fetchMoviesByGenre, searchMovie } from '../services/api';
    ...
    <div className="min-h-screen bg-[#141414]">
      ...
      <main className="container mx-auto px-4 py-8">
            ...
            <div className="bg-[#1a1a1a] rounded-lg overflow-hidden shadow-xl">
              <div className="flex flex-col md:flex-row gap-6 p-6">
                ...
                <div className="flex-1">
                  <h3 className="text-3xl font-bold text-white mb-2" data-testid="searched-movie-title">
                  ...
                  {searchedMovie.overview && (
                    <p className="text-gray-300 leading-relaxed" data-testid="searched-movie-overview">
                      {searchedMovie.overview}
                    </p>
                  )}
                </div>
        ...
        {loading ? (
          ...
          <div>
            <h2 className="text-2xl font-bold text-white mb-6" data-testid="page-title">{pageTitle}</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4" data-testid="movies-grid">
              {movies.map((movie) => (
                <MovieCard 
                  key={movie.id} 
                  movie={movie} 
